  ...
  return (
    <Router>
      <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased">
        ...
        <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 px-6 py-3 shadow-xs">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-5 text-xs font-semibold text-slate-700">
              ...
              <button onClick={() => setTipoOperacion("Arriendo")} className="hover:text-[#0070e0] cursor-pointer">Arriendo</button>
            </div>
        ...
        <Routes>
          <Route path="/" element={<HomeWithMap propiedadesFiltradas={propiedadesFiltradas} searchTerm={searchTerm} setSearchTerm={setSearchTerm} maxPrice={maxPrice} setMaxPrice={setMaxPrice} tipoOperacion={tipoOperacion} setTipoOperacion={setTipoOperacion} tipoInmueble={tipoInmueble} setTipoInmueble={setTipoInmueble} />} />
